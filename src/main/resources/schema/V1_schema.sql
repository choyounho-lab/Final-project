...
CREATE TABLE TRACK (
    ...
    TRACK_AUDIO_URL  VARCHAR2(500)  NOT NULL,
    TRACK_LYRICS     CLOB NOT NULL,
    TRACK_ARTIST_NAME VARCHAR2(500) NOT NULL,
    TRACK_COUNT NUMBER DEFAULT 0 NOT NULL,
...
CREATE TABLE PLAYLIST_TRACK (
    ...
    CONSTRAINT PK_PLAYLIST_TRACK PRIMARY KEY (PLAYLIST_ID),
